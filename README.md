...
[🚀 지금 시작하기](https://deepdivekr.github.io/openclaw-setup/) · [📥 오프라인 HTML 다운로드](https://github.com/deepdivekr/openclaw-setup/raw/master/openclaw-setup.html)
...
최근 온보딩 실패 이슈를 반영해 설치 스크립트(BAT/SH)를 수정했습니다.
...
자세한 내용은 루트 `CHANGELOG.md`를 참고하세요.
...
[deepdivekr.github.io/openclaw-setup](https://deepdivekr.github.io/openclaw-setup/)을 엽니다 (또는 [오프라인 HTML 다운로드](https://github.com/deepdivekr/openclaw-setup/raw/master/openclaw-setup.html) 후 브라우저에서 더블클릭).
...
1. [openclaw-setup.html 다운로드](https://github.com/deepdivekr/openclaw-setup/raw/master/openclaw-setup.html)
2. 브라우저에서 더블클릭
3. 동일하게 사용
